...
export default {
  getMovies(language, sortBy, pageCount) {
    return apiClient.get(`/discovr/movie/?api_key=${API_KEY}&language=${language}&sort_by=${sortBy}&include_adult=false&include_video=false&page=${pageCount}&vote_count.gte=150`);
  },
